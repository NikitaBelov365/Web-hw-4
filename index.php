...
$experience = [
    ...
    [
        ...
        'startDate' => 2017,
        'endDate' => 2021,
        'description' => 'Управление котельной',
    ],
    [
        'name' => 'Специалист по газовому хозяйству',
        'startDate' => 2015,
        'endDate' => 2017,
        'description' => 'Стройка',
    ],
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['startDate'];?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $experience[$i]['endDate'];?></span></h6>
